...
public:
  ...
  Vec3    operator - (Vec3 const &v) const    { 
	...
	v4sf  inpSIDM1,inpSIDM2,outSIDM;
	...
	inpSIDM1=__builtin_ia32_loadups(INPUT_F);	
	inpSIDM2=__builtin_ia32_loadups(VINPUT_F);
	outSIDM=__builtin_ia32_subps(inpSIDM1, inpSIDM2);	
				
	__builtin_ia32_storeups(OUTPUT_F, outSIDM); 
	outx=OUTPUT_F[0]; 
	outy=OUTPUT_F[1];
	outz=OUTPUT_F[2];
